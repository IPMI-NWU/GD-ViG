...
from End2End_EGDCXR.dataset_e2e import DatasetGaze_e2e
from End2End_EGDCXR.models.GAViG.GAViG import GAViG
...
def infer_e2e():
    ...
    # -------------------------------------------------------
    test_dir = '../Data/MIMIC_Gaze/test/'
    csv_path = '../Data/MIMIC_Gaze/mimic_part.csv'
    # -------------------------------------------------------
    model = GAViG(num_classes=3)
    base = "output/exp_EGDCXR/"
    model_path = base + "EGDCXR_0.8504.pth"
    # -------------------------------------------------------
    ...
    for img, gaze, label, img_path in dataloader_test:
        ...
        # append to list
        # -------------------------------------------------------
        pred_score_list.append(pred_score.detach().cpu().numpy())
